...
s = RandStream.create('mt19937ar','seed',54767876);%546589
...
N=127;                          %Number of time steps
dt=0.2;                         %samping period, affects process noise through Q

phi=0;                          %angle of the circular movement of the mouse
radius=0.8;
sm=[1+radius*cos(phi);1+radius*sin(phi)]; %true position of mouse
vm=[0; 0];
mouseinit=[sm; vm];



q=.08;    %std of expected process noise

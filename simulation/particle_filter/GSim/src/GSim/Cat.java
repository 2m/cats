...
public class Cat extends Actor {
	...
	private int positioningKalmanPeriod = 400;//500; //NB: working ok @500ms with q = 0.5f and stddegrees = 1f, working somewhat ok @750ms with q = 0.005f and stddegrees = 1f

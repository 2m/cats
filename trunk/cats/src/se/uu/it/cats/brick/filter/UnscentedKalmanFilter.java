...
public class UnscentedKalmanFilter
{
	...
	{	
		//long time_start_ut = System.currentTimeMillis();
		...
		/*long time_before_ut_loop = System.currentTimeMillis();
		long time_before_func_eval;
		long time_after_func_eval;
		long time_total_func_eval = 0;*/
		for (int k=0; k<L; k++)
		{	
			...
			//time_before_func_eval = System.currentTimeMillis();
			Y.setMatrix(0, Y_row_dim-1, k, k, func.eval(row_in_X) );
			//time_after_func_eval = System.currentTimeMillis();
			//time_total_func_eval += time_after_func_eval - time_before_func_eval;
			/*if (DEBUG2)
			{
		...
		//long time_after_ut_loop = System.currentTimeMillis();
		...
		*/
		...
		/*long time_end_ut = System.currentTimeMillis();
		long time_between_ut_loop_and_end = time_end_ut - time_after_ut_loop;
		long time_ut_loop = time_after_ut_loop - time_before_ut_loop;
		Logger.println("time_total_func_eval = " + time_total_func_eval + ", time_ut_loop = " + time_ut_loop + ", time_between_ut_loop_and_end = " + time_between_ut_loop_and_end);
		*/
		return output;
	}//end of ut()

...
public class AbsolutePositionUpdate extends Packet
{
	public byte _type = 0x05;
	...
	public AbsolutePositionUpdate()
	{		
	}
	
	public AbsolutePositionUpdate(float x, float y, float theta, int timestamp)
	{
		_x = x;
		_y = y;
		_theta = theta;
	...
	{
		return "AbsolutePositionUpdate[_type:"+_type+", _src:"+_src+", _x:"+_x+", _y:"+_y+", _theta:"+_theta+", _timestamp"+_timestamp+"]";
	}
	public String toStringMatlab()
	{
		return "S,"+_type+","+_src+","+_x+","+_y+","+_theta+","+_timestamp;
	}

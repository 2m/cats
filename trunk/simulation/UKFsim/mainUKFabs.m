...
stream = RandStream.create('mt19937ar','seed',456); %78693
...
q=.001;    %std of expected process noise
...
for k=1:N
    ...
    if k==1
        zsave(1:n,1)=pi; %should be changed to best initial guess
    else
        zsave(1:n,1)=zV(1:n,k-1);    %best guess
    end
    for i=actLandm
        zsave(i,1)=z(i,1);
    end
